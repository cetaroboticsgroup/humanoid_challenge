...
void setup(){
  ...
  double GP0[17] = {  0, 0, 0, 73.0, -73.0, 0, 0, 0, 0, -26.0, -26.0, 29.0, 29.0, -13.0, -13.0, 0, 0 };
   ...
   double GP1[17] = {   0, 22.0, -44.0, 63.0, -93.0, 72.0, -59.0, 0, 0, -26.0, -26.0, 29.0, 29.0, -13.0, -13.0, 0, 0 };
   MJC(GP1,300);
   
   double GP2[17] = {   0, 22.0, -70.0, 63.0, -93.0, 72.0, -59.0, 0, 0, -79.0, -83.0, 29.0, 29.0, 10.0, 11.0, 0, 0  };
   MJC(GP2,400);
   
   double GP3[17] = {  0, 22.0, -70.0, 63.0, -93.0, 72.0, -59.0, 0, 0, -79.0, -83.0, 29.0, 29.0, 10.0, 11.0, 0, 0 };
   MJC(GP3,500);
   
//   double GP4[17] = {  0, 22.0, -70.0, 63.0, -93.0, 72.0, -59.0, 0, 0, -79.0, -83.0, 29.0, 29.0, 10.0, 11.0, 0, 0};
//   MJC(GP4,1000);
//   
